...
class PointsController {
  ...
  async create(request: Request, response: Response) {
    ...
    const point = {
      image:
        "https://images.unsplash.com/photo-1550989460-0adf9ea622e2?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8OXx8bWFya2V0fGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=400&q=60",
      name,
      email,
      whatsapp,
      latitude,
